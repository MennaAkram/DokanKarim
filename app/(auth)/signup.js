      ...
      .then(() => {
        firebase
          ...
          .then(() => {
            setLoading(false);
            alert(
              "A verification email has been sent to your registered address. Please verify your account to proceed."
            );
          })
          .then(() => {
            firebase
    ...
    <View style={styles.container}>
      {Loading ? (
        ...
        <>
          <Image
            source={
              image ? { uri: image } : require("../../assets/images/logo.png")
            }
            style={styles.logo}
          />
      ...
      />
          ...
          <Pressable
            ...
            onPress={() =>
              registerUser(email, password, phone, image, username)
            }
          >
